...
# ChatGPT prompt (use the playground!)

---

Considering the following Markdown table structure and the following YAML file, return a Markdown table in a code block (!important) using the "trigger" value in the "Shortcut" column and the "replace" value in the "Character" column.
